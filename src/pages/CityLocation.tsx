...
import { useClinicsByCity } from "@/hooks/useClinicData";
...
export default function CityLocation() {
  ...
  const { data: clinicsRaw, isLoading, error } = useClinicsByCity(locationName || '');
  ...
  const paginatedClinics = clinics.slice((page - 1) * clinicsPerPage, page * clinicsPerPage);
  ...
  const cityName = locationName?.replace('-', ' ').replace(/\b\w/g, l => l.toUpperCase()) || '';
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              Find the best hair transplant clinics in {cityName} with verified reviews and transparent pricing.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-success-green mb-1">96%</div>
                <div className="text-sm text-muted-foreground">Satisfaction rate:</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-warning-amber mb-1">$1,800</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <h3 className="text-2xl font-bold text-foreground mb-2">{clinics.length} Clinics in {cityName}</h3>
          </div>
      </div>
      {/* Clinics Section */}
                          ...
                          <div className="flex items-start justify-between mb-4">
                            <div>
                              <div className="flex items-center space-x-2 mb-2">
                                <MapPin className="w-4 h-4 text-primary" />
                                <span className="text-sm text-muted-foreground font-medium">{clinic.city}</span>
                              </div>
                              ...
                              <div className="flex items-center space-x-4 mb-2">
                                ...
                                <div className="text-sm text-muted-foreground">Reviews 200+</div>
                              </div>
                            </div>
                            <Button
                              variant="outline"
